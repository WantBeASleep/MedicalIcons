...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        metavar="STATUS_CSV",
        help="CSV mapping item identifier to status icon name. Default: tools/build/build_project/statusicons.csv.",
    )
    parser.add_argument(
        "--disable-staus-icons",
    ...
    parser.add_argument(
        ...
        type=Path,
        metavar="DIR",
        help="Save 64x64 item icons after status icon overlay. Default: tools/build/build_project/status_icons.",
    )
    parser.add_argument(
        "--atlas-out",
        type=Path,
    ...
    parser.add_argument(
        ...
        help="Directory with source texture item asset folders.",
    )
    parser.add_argument(
        "--statusicons-dir",
        type=Path,
...
def render_atlases_lua(ctx: BuildContext, icons_path: Path, sprites_path: Path) -> str:
    lines = [
        "-- This file is generated by tools/build/build_project/build_project.py.",
